    ...
    const testConnection = useCallback(async () => {
        try {
            ...
            if (res.status === 200) {
                ...
                const hasInternet = user && (user.expires_on > user.now) && !user.paused;

                if (hasInternet && window.location.pathname !== "/") {
                    ...
                    if (r >= 2) {
                        ...
                        url.searchParams.set("r", (r + 1).toString());
